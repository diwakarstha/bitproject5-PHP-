...
class AddRoomForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
                ...
                "floor": forms.NumberInput(attrs={'class': 'form-control', 'min':"1", 'max':"100"}),
                "price": forms.NumberInput(attrs={'class': 'form-control', 'min':"1", 'max':"1000000"}),
                ...
                "parking": forms.CheckboxInput(attrs={'class': 'form-check-input mt-2'}),
...
class EditForm(forms.ModelForm):
    class Meta:
        model = Room
        fields = ["city", "location", "house_number", "floor", "price", "image1", "image2", "image3", "water", "internet", "parking","description", 'room_status']
    
        widgets = {
                "city": forms.Select(attrs={'class': 'form-control'}),
                "location": forms.Select(attrs={'class': 'form-control'}),
                "house_number": forms.TextInput(attrs={'class': 'form-control'}),
                "floor": forms.NumberInput(attrs={'class': 'form-control', 'min':"1", 'max':"3"}),
                "price": forms.NumberInput(attrs={'class': 'form-control', 'min':"1", 'max':"8"}),
                "water": forms.CheckboxInput(attrs={'class': 'form-check-input mt-2'}),
                "internet": forms.CheckboxInput(attrs={'class': 'form-check-input mt-2'}),
                "parking": forms.CheckboxInput(attrs={'class': 'form-check-input mt-2'}),
                "description": forms.Textarea(attrs={'class': 'form-control'}),
